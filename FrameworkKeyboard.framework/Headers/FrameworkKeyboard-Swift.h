...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FrameworkKeyboard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC17FrameworkKeyboard10AppContext")
...
SWIFT_CLASS("_TtC17FrameworkKeyboard6Config")
...
SWIFT_CLASS("_TtC17FrameworkKeyboard27EmojiKeyboardViewController")
@interface EmojiKeyboardViewController : UIInputViewController <UIPopoverPresentationControllerDelegate, UIWebViewDelegate>
...
SWIFT_CLASS("_TtC17FrameworkKeyboard15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(FrameworkKeyboard)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FrameworkKeyboard)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FrameworkKeyboard)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FrameworkKeyboard)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FrameworkKeyboard)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC17FrameworkKeyboard12TaskDelegate")
